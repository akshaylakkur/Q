...
export interface CallbackServer {
   ...
   *  - the authorization server returns an error → Error('OAuth error: <code>')
   */
...
const SUCCESS_HTML =
  ...
  '<p>You can close this tab and return to Qode.</p>' +
  '</body></html>';
...
const ERROR_HTML =
  ...
  '<p>The authorization server reported an error. Return to Qode for details.</p>' +
  '</body></html>';
